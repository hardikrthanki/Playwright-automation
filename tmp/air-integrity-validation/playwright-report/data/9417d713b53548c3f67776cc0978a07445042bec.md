...
- Name: air-integrity-fixture.spec.ts >> Failure Evidence - fails with screenshot trace and note evidence
- Location: tmp\air-integrity-validation\tests\air-integrity-fixture.spec.ts:22:5
...
```yaml
- main [ref=e2]:
  - heading "AIR failed evidence validation" [level=1] [ref=e3]
  - paragraph [ref=e4]: This test intentionally fails so AIR can map per-test evidence.
```
