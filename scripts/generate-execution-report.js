  ...
  !demoMode && failedTests.length === 0
    ? `
      <div class="success-empty-state">
        ...
        <h2>Excellent. No failed tests detected.</h2>
        <p>All executed checks passed in this run. Release blockers are currently none, and evidence remains available for review through Evidence.</p>
        <div class="success-grid">
          <span><b>${executiveData.total}</b>Total Tests</span>
          <span><b>${executiveData.passed}</b>Passed</span>
          <span><b>0</b>Failed</span>
          <span><b>None</b>Blockers</span>
        </div>
      </div>`
...
const footerHtml =
  'Generated by AIR Platform &bull; Automation Intelligence Platform &bull; Version 1.0';
...
const releaseStatusBadge =
  `<span class="release-status-badge ${releaseTone}">${escapeHtml(executiveData.releaseDecision)}</span>`;
const releaseStatusCompact =
  `<span class="release-status-badge compact ${releaseTone}">${escapeHtml(executiveData.releaseDecision)}</span>`;
...
const roadmapVersions = [
  {
    ...
    goal: 'Executive visibility into software quality',
  },
  {
    version: 'AIR v1.1',
    title: 'AIR Core',
    ...
    features: ['AIR Core Architecture', 'Playwright Parser', 'air-results.json', 'Quality Engine', 'Release Engine', 'Journey Engine', 'Module Engine', 'Evidence Engine', 'Search Engine', 'History Engine'],
    goal: 'Create a reusable AIR Core architecture',
  },
  {
    version: 'AIR v1.2',
    title: 'Quality Analytics',
    status: 'Planned',
    purpose: 'Help teams understand quality trends across executions.',
    ...
    goal: 'Track quality trends across executions',
  },
  {
    version: 'AIR v1.3',
    ...
    goal: 'Help teams investigate issues faster',
  },
  {
    version: 'AIR v2.0',
    title: 'Integrations',
    ...
    goal: 'Integrate with the engineering ecosystem',
  },
  {
    version: 'AIR v2.5',
    ...
    goal: 'Support multiple execution sources',
  },
  {
    version: 'AIR v3.0',
    ...
    goal: 'Unify all quality validations',
  },
  {
    version: 'AIR v4.0',
    ...
    goal: 'Scale AIR for enterprise organizations',
  },
  {
    version: 'AIR v5.0',
    ...
    goal: 'Transform AIR into an Engineering Intelligence Platform',
  },
];
...
<div class="app">
  ...
  <aside class="sidebar">
    ...
    <nav class="nav">
      ...
      <a class="disabled" href="#insight" aria-disabled="true">${navIcon('analytics')}<span>Analytics</span><em>Coming Soon</em></a>
  ...
  <main>
    ...
    <section class="page cover-page" id="cover">
      <div class="cover-hero">
        ...
        <div class="cover-stats">
          ...
          <div class="cover-stat"><span>Release Recommendation</span>${releaseStatusCompact}</div>
          <div class="cover-stat interactive-card" data-open-quality><span>Quality Score</span><strong>${executiveData.qualityScore}%</strong></div>
    ...
    <section class="page hero" id="executive">
      ...
      <div class="grid two">
        ...
        <div class="panel">
          ...
          <div class="ai-metric-grid">
            <div class="ai-metric"><span>Release</span>${releaseStatusCompact}</div>
            <div class="ai-metric"><span>Confidence</span><strong>${executiveConfidence}%</strong></div>
            <div class="ai-metric"><span>Risk</span><strong>${escapeHtml(estimatedReleaseRisk)}</strong></div>
            <div class="ai-metric interactive-card" data-open-quality><span>Quality</span><strong>${executiveData.qualityScore}%</strong></div>
          </div>
          <br>
    ...
    <section class="page" id="roadmap">
      ...
      <div class="panel">
        ...
        <p>AIR v1.0 is complete. AIR v1.1 is focused on AIR Core, parser architecture, normalized data, evidence correlation, and engines that make the platform reusable beyond Playwright.</p>
      </div>
      <br>
  ...
  <section class="modal" id="qualityModal" aria-hidden="true">
    <div class="modal-header">
      ...
      <button class="modal-close" type="button" data-close-panels aria-label="Close quality score explainer">Ã—</button>
    </div>
    <table>
  ...
  <section class="modal" id="evidenceModal" aria-hidden="true">
    <div class="modal-header">
      ...
      <button class="modal-close" type="button" data-close-panels aria-label="Close evidence preview">Ã—</button>
    </div>
